...
# Represents the metadata associated with a field on an entity.
...
# + refField - The name of the field in `entityName` that is referenced
...
# + fieldName - The name of the field in `entity` that is being joined  
