...
client class MedicalItemClient {
    ...
    remote function read(map<anydata>|persist:FilterQuery? filter = ()) returns stream<MedicalItem, error?>|error {
    ...
    remote function update(map<anydata> 'object, map<anydata>|persist:FilterQuery filter) returns error? {
        _ = check self.persistClient.runUpdateQuery('object, filter);
    }

    remote function delete(map<anydata>|persist:FilterQuery filter) returns error? {
