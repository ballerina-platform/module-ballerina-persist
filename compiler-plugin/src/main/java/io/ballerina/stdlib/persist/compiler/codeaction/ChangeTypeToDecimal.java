...
import static io.ballerina.stdlib.persist.compiler.codeaction.PersistCodeActionName.CHANGE_TYPE_TO_DECIMAL;

/**
 * Change type to decimal code action.
 */
public class ChangeTypeToDecimal extends AbstractChangeToSupportedType {
    @Override
    protected String getName() {
        return CHANGE_TYPE_TO_DECIMAL.getName();
    }
