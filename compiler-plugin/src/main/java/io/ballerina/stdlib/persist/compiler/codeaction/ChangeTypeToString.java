...
import static io.ballerina.stdlib.persist.compiler.codeaction.PersistCodeActionName.CHANGE_TYPE_TO_STRING;

/**
 * Change type to string code action.
 */
public class ChangeTypeToString extends AbstractChangeToSupportedType {
    @Override
    protected String getName() {
        return CHANGE_TYPE_TO_STRING.getName();
    }
