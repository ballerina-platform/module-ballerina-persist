...
public enum DiagnosticsCodes {
    ...
    PERSIST_205("PERSIST_205", "an entity field of ''{0}'' type is not supported", ERROR),
    PERSIST_206("PERSIST_206", "an entity field of array type is not supported", ERROR),
    ...
    PERSIST_304("PERSIST_304", "entity should not contain foreign key field for relation ''{0}''", ERROR),
