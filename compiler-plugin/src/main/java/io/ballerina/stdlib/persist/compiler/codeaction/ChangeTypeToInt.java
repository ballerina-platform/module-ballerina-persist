...
import static io.ballerina.stdlib.persist.compiler.codeaction.PersistCodeActionName.CHANGE_TYPE_TO_INT;

/**
 * Change type to int code action.
 */
public class ChangeTypeToInt extends AbstractChangeToSupportedType {
    @Override
    protected String getName() {
        return CHANGE_TYPE_TO_INT.getName();
    }
